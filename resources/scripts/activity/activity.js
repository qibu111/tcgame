...
var activityAddFormValidator = $(document.activityAddForm).validate(validateOptions);

var activityEditFormValidator = $(document.activityEditForm).validate(validateOptions);
