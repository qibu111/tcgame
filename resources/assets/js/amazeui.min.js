    ...
    return function t(e, i, n) {
        ...
        3 : [function(t, e, i) {
            ...
            s.Class = function(t) {
                ...
                s.defaults), o(this.options, t), t.debug && "undefined" == typeof t.logging && (this.options.logging = !0), l) {
            ...
            s.Class.prototype = {
                ...
                show: function(t) {
                    ...
                    this.updateSession(),
                    this.applicationIcon || (this.applicationIcon = document.querySelector("ios" == s.OS ? 'head link[rel^=apple-touch-icon][sizes="152x152"],head link[rel^=apple-touch-icon][sizes="144x144"],head link[rel^=apple-touch-icon][sizes="120x120"],head link[rel^=apple-touch-icon][sizes="114x114"],head link[rel^=apple-touch-icon]': 'head link[rel^="shortcut icon"][sizes="196x196"],head link[rel^=apple-touch-icon]'));
                    var n = "";
        ...
        7 : [function(t, e, i) {
            ...
            a.prototype.fill = function() {
                ...
                for (var v = 0; 12 > v;) this.onRender(t.setFullYear(e, v)) && f.eq(v).addClass("am-disabled"),
                v++;
                ...
                p += '<span class="' + g + ( - 1 === y || 10 === y ? " am-datepicker-old": "") + (m === e ? " am-active": "") + '">' + e + "</span>",
                e += 1;
                w.html(p)
            },
        ...
        9 : [function(t, e, i) {
            ...
            n(document).on("hover.dropdown.amui.data-api", ".am-dropdown form",
            function(t) {
                t.stopPropagation()
            }),
            ...
            n.flexslider = function(t, e) {
                ...
                f = {
                    init: function() {
                        ...
                        m && f.asNav.setup(),
                        r && i.vars.touch && f.touch(),
                        (!p || p && i.vars.smoothHeight) && n(window).bind("resize orientationchange focus", f.resize),
                    ...
                    directionNav: {
                        setup: function() {
                            ...
                            i.controlsContainer ? (n(i.controlsContainer).append(t), i.directionNav = n("." + o + "direction-nav li a", i.controlsContainer)) : (i.append(t), i.directionNav = n("." + o + "direction-nav li a", i)),
                            f.directionNav.update(),
                            i.directionNav.bind(l,
                            function(t) {
                                t.preventDefault();
                                var e; ("" === c || c === t.type) && (e = i.getTarget(n(this).hasClass(o + "next") ? "next": "prev"), i.flexAnimate(e, i.vars.pauseOnAction)),
                                "" === c && (c = t.type),
                                f.setToClearWatchedEvent()
                            })
                        },
                    ...
                    pausePlay: {
                        setup: function() {
                            ...
                            i.controlsContainer ? (i.controlsContainer.append(t), i.pausePlay = n("." + o + "pauseplay a", i.controlsContainer)) : (i.append(t), i.pausePlay = n("." + o + "pauseplay a", i)),
                            f.pausePlay.update(i.vars.slideshow ? o + "pause": o + "play"),
                            i.pausePlay.bind(l,
                            function(t) {
                                t.preventDefault(),
                                ("" === c || c === t.type) && (n(this).hasClass(o + "pause") ? (i.manualPause = !0, i.manualPlay = !1, i.pause()) : (i.manualPause = !1, i.manualPlay = !0, i.play())),
                                "" === c && (c = t.type),
                                f.setToClearWatchedEvent()
                            })
                        },
                    ...
                    touch: function() {
                        ...
                        function n(t) {
                            ...
                            T = t.touches[0].pageY,
                            g = u ? c - T: c - b,
                            y = u ? Math.abs(g) < Math.abs(b - m) : Math.abs(g) < Math.abs(T - m);
                            var e = 500; (!y || Number(new Date) - w > e) && (t.preventDefault(), !p && i.transitions && (i.vars.animationLoop || (g /= 0 === i.currentSlide && 0 > g || i.currentSlide === i.last && g > 0 ? Math.abs(g) / v + 2 : 1), i.setProps(f + g, "setTouch")))
                        }
                        function s(e) {
                        ...
                        function r(e) {
                            ...
                            if (i) {
                                ...
                                return x += u ? s: n,
                                g = x,
                                y = u ? Math.abs(x) < Math.abs( - n) : Math.abs(x) < Math.abs( - s),
                    ...
                    resize: function() { ! i.animating && i.is(":visible") && (d || i.doMath(), p ? f.smoothHeight() : d ? (i.slides.width(i.computedW), i.update(i.pagingCount), i.setProps()) : u ? (i.viewport.height(i.h), i.setProps(i.h, "setTotal")) : (i.vars.smoothHeight && f.smoothHeight(), i.newSlides.width(i.computedW), i.setProps(i.computedW, "setTotal")))
                    },
                ...
                i.wrapup = function(t) {
                    p || d || (0 === i.currentSlide && i.animatingTo === i.last && i.vars.animationLoop ? i.setProps(t, "jumpEnd") : i.currentSlide === i.last && 0 === i.animatingTo && i.vars.animationLoop && i.setProps(t, "jumpStart")),
                    i.animating = !1,
                ...
                i.setProps = function(t, e, n) {
                    ...
                    i.transitions && (s = u ? "translate3d(0," + s + ",0)": "translate3d(" + s + ",0,0)", n = void 0 !== n ? n / 1e3 + "s": "0s", i.container.css("-" + i.pfx + "-transition-duration", n), i.container.css("transition-duration", n)),
                    i.args[i.prop] = s,
                ...
                i.setup = function(t) {
                    ...
                    i.vars.smoothHeight && f.smoothHeight();
                        ...
                        "init" === t && (i.viewport = n('<div class="' + o + 'viewport"></div>').css({
                            overflow: "hidden",
                            position: "relative"
                        }).appendTo(i).append(i.container), i.cloneCount = 0, i.cloneOffset = 0, h && (s = n.makeArray(i.slides).reverse(), i.slides = n(s), i.container.empty().append(i.slides))),
                        i.vars.animationLoop && !d && (i.cloneCount = 2, i.cloneOffset = 1, "init" !== t && i.container.find(".clone").remove(), i.container.append(f.uniqueID(i.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(f.uniqueID(i.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
                        i.newSlides = n(i.vars.selector, i),
                        e = h ? i.count - 1 - i.currentSlide + i.cloneOffset: i.currentSlide + i.cloneOffset,
                        u && !d ? (i.container.height(200 * (i.count + i.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
                            i.newSlides.css({
                                display: "block"
                            }),
                            i.doMath(),
                ...
                i.doMath = function() {
                    ...
                    d ? (i.itemT = i.vars.itemWidth + e, i.minW = n ? n * i.itemT: i.w, i.maxW = s ? s * i.itemT - e: i.w, i.itemW = i.minW > i.w ? (i.w - e * (n - 1)) / n: i.maxW < i.w ? (i.w - e * (s - 1)) / s: i.vars.itemWidth > i.w ? i.w: i.vars.itemWidth, i.visible = Math.floor(i.w / i.itemW), i.move = i.vars.move > 0 && i.vars.move < i.visible ? i.vars.move: i.visible, i.pagingCount = Math.ceil((i.count - i.visible) / i.move + 1), i.last = i.pagingCount - 1, i.limit = 1 === i.pagingCount ? 0 : i.vars.itemWidth > i.w ? i.itemW * (i.count - 1) + e * (i.count - 1) : (i.itemW + e) * i.count - i.w - e) : (i.itemW = i.w, i.pagingCount = i.count, i.last = i.count - 1),
                    i.computedW = i.itemW - i.boxPadding
                },
                i.update = function(t, e) {
                    i.doMath(),
                    d || (t < i.currentSlide ? i.currentSlide += 1 : t <= i.currentSlide && 0 !== t && (i.currentSlide -= 1), i.animatingTo = i.currentSlide),
                    i.vars.controlNav && !i.manualControls && ("add" === e && !d || i.pagingCount > i.controlNav.length ? f.controlNav.update("add") : ("remove" === e && !d || i.pagingCount < i.controlNav.length) && (d && i.currentSlide > i.last && (i.currentSlide -= 1, i.animatingTo -= 1), f.controlNav.update("remove", i.last))),
                ...
                i.addSlide = function(t, e) {
                    ...
                    i.count += 1,
                    i.last = i.count - 1,
                    u && h ? void 0 !== e ? i.slides.eq(i.count - e).after(s) : i.container.prepend(s) : void 0 !== e ? i.slides.eq(e).before(s) : i.container.append(s),
                    i.update(e, "add"),
                ...
                i.removeSlide = function(t) {
                    ...
                    i.count -= 1,
                    i.last = i.count - 1,
                    isNaN(t) ? n(t, i.slides).remove() : u && h ? i.slides.eq(i.last).remove() : i.slides.eq(t).remove(),
                    i.doMath(),
                    i.update(e, "remove"),
                    i.slides = n(i.vars.selector + ":not(.clone)", i),
                    i.setup(),
        ...
        12 : [function(t, e, i) {
            ...
            c.prototype.open = function(t) {
                ...
                if (!this.active && this.$element.length) {
                    ...
                    a.open(e),
                    e.show().redraw(),
                    n || this.isActions || (o && (o = parseInt(o, 10), c.width = o + "px", c.marginLeft = -parseInt(o / 2) + "px"), r ? (r = parseInt(r, 10), c.marginTop = -parseInt(r / 2) + "px", this.$dialog.css({
                        height: r + "px"
                    })) : c.marginTop = -parseInt(e.height() / 2, 10) + "px", e.css(c)),
            ...
            c.prototype.events = function() {
                ...
                i.find("[data-am-modal-close], .am-modal-btn").on("click.close.modal.amui",
                function(i) {
                    i.preventDefault();
                    var n = s(this);
        ...
        17 : [function(t, e, i) {
            ...
            c.prototype.refreshSlides = function() {
                ...
                r && (1 === r && i.addClass(e.className.onlyOne), a.not("[" + l + "]").each(function(e, i) {
                    ...
                    i.setAttribute(l, "1"),
                    t.imgUrls.push(a),
                    s = s.add(n('<li data-src="' + a + '" data-title="' + r + '"></li>')),
                    o = o.add(n("<li>" + (e + 1) + "</li>"))
        ...
        26 : [function(t, e, i) {
            ...
            o.prototype.validate = function(t) {
                ...
                var b, T = function(t) {
                    this.markField(t),
                    o.trigger("validated.field.validator.amui", t).data("validity", t);
                    var i = c || u;
        ...
        30 : [function(t, e, i) {
            ...
            U.prototype = {
                set: function(t) {
                    t == Kt && (t = this.compute()),
                    Jt && (this.manager.element.style[Gt] = t),
            ...
            l(G, Q, {
                ...
                directionTest: function(t) {
                    ...
                    o = t.deltaX,
                    a = t.deltaY;
                    return s & e.direction || (e.direction & It ? (s = 0 === o ? At: 0 > o ? Mt: $t, i = o != this.pX, n = Math.abs(t.deltaX)) : (s = 0 === a ? At: 0 > a ? Pt: Nt, i = a != this.pY, n = Math.abs(t.deltaY))),
                    t.direction = s,
            ...
            l(et, Q, {
                ...
                attrTest: function(t) {
                    ...
                    return i & (It | Ot) ? e = t.velocity: i & It ? e = t.velocityX: i & Ot && (e = t.velocityY),
